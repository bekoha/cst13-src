...
// each file portal is split into two memory portals
	...
	// create forward portal
		...
		if (l->numportals == MAX_PORTALS_ON_LEAF)
			Error ("Leaf (portal %d) with too many portals. Use cstbsp -glview to compile, then glview -portal -portalhighlight X to view the problem.", i );
...
void PrintUsage( int argc, char **argv )
{
	...
	Warning(	
		"usage  : cstvis [options...] bspfile\n"
		"example: cstvis -fast c:\\hl2\\hl2\\maps\\test\n"
		"\n"
		"Common options:\n"
		"\n"
		...
		"  -threads        : Control the number of threads cstbsp uses (defaults to the #\n"
